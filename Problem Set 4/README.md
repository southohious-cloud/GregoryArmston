...
Problem Set 4 introduces external libraries, stylized output, and real‑time data access. These exercises reinforce string manipulation, randomness, API usage, and formatted interaction with user input.
...
5. [**05_professor.py**](05_professor.py)  
